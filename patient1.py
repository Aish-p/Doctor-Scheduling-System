...
def main():
    ...
    #read patient1.txt
    with open('/home/ubantu1/Desktop/CN_PROJECT/input/patient1.txt', 'r') as f:
        store=f.read()
    ...
    if reply == "Success":
        ...
        if result == 'notavailable':
            ...
            print result
            udpport=int(result)
            address=('192.168.56.102', udpport)
            ...
            try:
                with open('/home/ubantu1/Desktop/CN_PROJECT/input/patient1insurance.txt', 'r') as f:
                    insurance=f.read()
            ...
            print '\n\nDoctors port number    ',    result
            print '\nPatient                 patient1'
            print '\nInsurance              ',     insurance
            print 'Cost                   ',        cost 
            print '\nPhase3: End of Phase3 for Patient1'
            udpsocket.close()
